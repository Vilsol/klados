...
/**
 * @returns {$CancellablePromise<volumebrowser$0.Manager | null>}
 */
export function VolumeBrowserManager() {
    return $Call.ByID(1858241892).then(/** @type {($result: any) => any} */(($result) => {
