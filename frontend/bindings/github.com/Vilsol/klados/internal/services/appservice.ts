...
export function PluginService(): $CancellablePromise<$models.PluginService | null> {
    return $Call.ByID(3698521).then(($result: any) => {
...
export function SetPluginService(svc: $models.PluginService | null): $CancellablePromise<void> {
